...
params = {'learning_rate': [1e-3, 1e-2, 1e-1, 0.5, 1, 2], 'n_estimators': [5, 10, 25, 50, 100]}

profits = []
for i in range(len(params['learning_rate'])):
    for j in range(len(params['n_estimators'])):
            clf = ABC(random_state=7, learning_rate=params['learning_rate'][i], n_estimators=params['n_estimators'][j])
            print(clf)
            ...
            profits.append((profit1, params['learning_rate'][i], params['n_estimators'][j]))

profits_s = sorted(profits, key=lambda x: x[0], reverse=True)
print("  1st place:", {'profit1': profits_s[0][0], 'learning_rate': profits_s[0][1], 'n_estimators': profits_s[0][2]})
print("  2nd place:", {'profit1': profits_s[1][0], 'learning_rate': profits_s[1][1], 'n_estimators': profits_s[1][2]})
print("  3rd place:", {'profit1': profits_s[2][0], 'learning_rate': profits_s[2][1], 'n_estimators': profits_s[2][2]})
print("  4th place:", {'profit1': profits_s[3][0], 'learning_rate': profits_s[3][1], 'n_estimators': profits_s[3][2]})
print("  5th place:", {'profit1': profits_s[4][0], 'learning_rate': profits_s[4][1], 'n_estimators': profits_s[4][2]})
